...
function getScreenshotName(basePath) {
  return function(context) {
    var suiteName = context.test.parent;
    var testName = context.test.title;
    var resolution = context.meta.width || context.meta.orientation || 'unknown';
    var browserVersion = parseInt(/\d+/.exec(context.browser.version)[0], 10);
    var browserName = context.browser.name;

    return path.join(basePath, `${suiteName}_${testName}_${resolution}_${browserName}_v${browserVersion}.png`);
  };
}
